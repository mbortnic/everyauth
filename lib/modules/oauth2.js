...
everyModule.submodule('oauth2')
  ...
  .getAuthUri( function (req, res, next) {
    ...
    // Microsoft Live Connect requires a response_type=code parameter in the url
    // Add this to the params array
    if (this.name == 'liveconnect') params.response_type = 'code';
  ...
  .getAccessToken( function (code) {
    ...
    // Microsoft Live Connect requires additional parameter to get access token
    if (this.name == 'liveconnect') params.grant_type = 'authorization_code';      
